...
Сама выдача Яндекс Карт по городу целиком обрывается примерно на 60 результатах на рубрику, сколько бы страниц ни листать (это ограничение самого Яндекса, не парсера). Для 16 крупных городов (Москва, Санкт-Петербург, Екатеринбург, Казань, Новосибирск, Нижний Новгород, Самара, Ростов-на-Дону, Краснодар, Челябинск, Уфа, Пермь, Воронеж, Волгоград, Красноярск, Омск) CLI автоматически обходит это: если поиск по рубрике "упирается" в потолок, город делится на сетку зон и досматривается по частям, с дедупликацией по business_id. В логе это видно как событие `query.area_expanded`. Для остальных локаций (не из списка) действует прежнее поведение без разбиения на зоны.
